...
//							}
							if (mAdsCounter % OUT_COUNTER == 0 && Variables.mFirstAds && GDApplication.getmInstance().getTruckMedia().getcAds().getExtendTypeTrucksMap(Contant.ADS_EXTEND_TYPE_FIRST).size() > 0) { //450// 10 minutes is one cycle
								mRegularAdStart = true;
							}
